function App() {
  ...
  <section id="register-page" className="register">
   ...
   Dashboard Page ( htmlFor Guests and Users ) 
  <section id="dashboard-page" className="dashboard">
      <h1>Dashboard</h1>
       Display ul: with list-items htmlFor All pets (If any) 
   ...
   Details Page ( htmlFor Guests and Users ) 
  <section id="details-page" className="details">
      <div className="pet-information">
          ...
          <div className="actions">
               Edit/Delete buttons ( Only htmlFor creator of this pet )  
              <a className="button" href="#">Edit</a>
              <a className="button" href="#">Delete</a>
              
               Bonus 
               Like button ( Only htmlFor logged-in users, which is not creators of the current pet ) 
              <a className="button" href="#">Like</a>
              
               ( htmlFor Guests and Users )  
              <div className="likes">
  ...
  <section id="edit-page" className="edit">
   ...
   My Pets Page ( Only htmlFor logged-in users ) 
  <section id="my-pets-page" className="my-pets">
      <h1>My Pets</h1>
       Display ul: with list-items htmlFor every user's pet (if any) 
